...
import {
  ...
  PlatformWindowToken
} from '@xplat-sample-electron-routing5/core';
...
export class XplatSampleElectronRouting5CoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: XplatSampleElectronRouting5CoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'XplatSampleElectronRouting5CoreModule');
  }
}
